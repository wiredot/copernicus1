...
class CP_Admin {
	...
	public function load_js() {
		...
		wp_register_script('cp_admin', get_bloginfo ('template_directory') . '/static/js/cp-admin.js', array('jquery','jquery-ui-core', 'jquery-ui-sortable'), $this->theme['version'], 1);
		wp_enqueue_script('cp_admin');
	}
	
	public function load_css() {
		wp_register_style('cp_admin', get_bloginfo ('template_directory') . '/static/css/cp-admin.css', '', $this->theme['version'], 'all');
